...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0061_concert_historicalconcert_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('tv', 'TV Show'), ('season', 'TV Season'), ('episode', 'Episode'), ('movie', 'Movie'), ('anime', 'Anime'), ('manga', 'Manga'), ('game', 'Game'), ('book', 'Book'), ('comic', 'Comic'), ('boardgame', 'Boardgame'), ('concert', 'Concert')], default='tv', max_length=10),
        ),
        migrations.AddConstraint(
            model_name='user',
            constraint=models.CheckConstraint(condition=models.Q(('last_search_type__in', ['tv', 'movie', 'anime', 'manga', 'game', 'book', 'comic', 'boardgame', 'concert'])), name='last_search_type_valid'),
        ),
    ]
