...
urlpatterns = [
    ...
    path('media/<source:source>/movie/<str:media_id>/mark-watched/', views.mark_movie_watched, name='mark_movie_watched'),
    path('media/<source:source>/movie/<str:media_id>/unmark-watched/', views.unmark_movie_watched, name='unmark_movie_watched'),
