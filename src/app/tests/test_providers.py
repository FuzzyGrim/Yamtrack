...
class Search(TestCase):
    ...
    def test_anime(self: "Search") -> None:
    ...
    def test_anime_not_found(self: "Search") -> None:
...
class Metadata(TestCase):
    ...
    def test_anime(self: "Metadata") -> None:
    ...
    @patch("requests.get")
    def test_anime_unknown(self: "Metadata", mock_data: "patch") -> None:
    ...
    def test_tv(self: "Metadata") -> None:
    ...
    def test_movie(self: "Metadata") -> None:
    ...
    @patch("requests.get")
    def test_movie_unknown(self: "Metadata", mock_data: "patch") -> None:
